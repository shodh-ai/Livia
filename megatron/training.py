...
def setup_model_and_optimizer(neox_args, use_cache=False, iteration=None):
    ...
    if neox_args.deepspeed:
        ...
        if neox_args.moe_num_experts > 1 and (neox_args.moe_type == "megablocks" or neox_args.moe_type == "deepspeed"):
